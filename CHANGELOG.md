...
- **Those cards can also try the mixture-of-experts tile**, which was locked to the other width without ever being measured on one: `TOSH_MMID_WIDE_W64_ENABLE=1` enables it.
