...
- **Speculative decoding carries the gain too.** On a Qwen3.5 4B, MTP goes from 63.6 to 72.6 tokens/s and DFlash from 56.9 to 63.9, with the draft acceptance rate unchanged to the fifth decimal, so the speedup is the kernels and not a different acceptance pattern.
