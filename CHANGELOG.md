...
- **Subtitles burned into a video can be styled, and previewed before exporting.** Typeface, size, colour, box or outline, position and margins, shown over a real frame of your own clip with its longest caption.
